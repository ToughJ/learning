...
//            this.population.bestChromosom.testPrint();
            int tE=-1;
            if (tE < this.population.bestChromosom.truckEnd.size()-1)  tE++;
            ...
            printer.println("\tTotalDistance : "+this.population.bestChromosom.getTotalDistance()+
            		...
            		"\tCarUsed : "+this.population.bestChromosom.getCarCountInc()+
            		"\tTruckUsed : "+this.population.bestChromosom.getTruckCountInc());
            printer.println();
        }
        printer.close();
    }
